...
//Надо сделать:
//найти способ выйти из рекурсии за один шаг. Не печатать All done несколько раз.

//разобраться с перегенерацией уровней, иногда виснет. почему?

//иногда выход попадает в границы и до него не добраться.

//добавить проверку на размер консоли

//наверное надо сделать чтоб реже в высоту и больше в ширину
